...
int main(int argc, char* argv[])
{
	...
	const char* login_params			=	"appid = 59a8ea58"; // 登录参数，appid与msc库绑定,请勿随意改动
	...
	* sch:              是否使用语义标识
	*/
	const char* session_begin_params ="nlp_version =3.0,trssrc=its,addcap = translate,orilang = en,translang = cn,scene = main,sch=1,sub=iat,domain = iat, language = zh_cn, accent = mandarin,aue = speex-wb;7, sample_rate = 16000";
